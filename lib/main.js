...
exports.main = function() {
    ...
    function ReInitMenu() 
    {
        ...
        {
            //console.log("ss.storage.engines[i].hasOwnProperty(\"check\")=" + ss.storage.engines[i].hasOwnProperty("check"));
			//console.log("ss.storage.engines[i].check=" + ss.storage.engines[i].check);
			
			if (ss.storage.engines[i].hasOwnProperty("check") == false ||
				ss.storage.engines[i].check == "true")
			{
